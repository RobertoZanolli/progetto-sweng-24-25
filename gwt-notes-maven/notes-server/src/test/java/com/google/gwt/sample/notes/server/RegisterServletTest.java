...
public class RegisterServletTest {
    ...
    public void setUp() throws IOException {
        ...
        tempDbFile = File.createTempFile("users-test", ".db");
        ...
        servlet = new RegisterServlet(tempDbFile.getAbsolutePath());
        servlet.init();
        assertNotNull("RegisterServlet users map should be initialized", getUsersMap(servlet));
    }
    ...
    // Helper to access private users map for assertion
    private Object getUsersMap(RegisterServlet servlet) {
        try {
            java.lang.reflect.Field usersField = RegisterServlet.class.getDeclaredField("users");
            usersField.setAccessible(true);
            return usersField.get(servlet);
        } catch (Exception e) {
            return null;
        }
    }
